...
NODE_CLASS_MAPPINGS = {
    "IntegerInput_PixelML": IntegerInput,
    "FloatInput_PixelML": FloatInput,
    "BooleanInput_PixelML": BooleanInput,
    "StringInput_PixelML": StringInput,
    "SaveImage_PixelML": SaveImage,
    "LoadImageFromURL_PixelML": LoadImageFromURL,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "IntegerInput_PixelML": "Integer Input (PixelML)",
    "FloatInput_PixelML": "Float Input (PixelML)",
    "BooleanInput_PixelML": "Boolean Input (PixelML)",
    "StringInput_PixelML": "String Input (PixelML)",
    "SaveImage_PixelML": "Save Image (PixelML)",
    "LoadImageFromURL_PixelML": "Load Image From URL (PixelML)",
}
